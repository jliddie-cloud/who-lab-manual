...
4. Process and analyze data with internal replication and masking
5. Use reporting checklists with manuscripts
6. Publish preprints
7. Publish data (when possible) and replication scripts
